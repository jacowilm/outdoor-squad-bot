...
(function() {
    ...
    style.textContent = `
        ...
        .os-chip { border: 1px solid #e0e0e0; background: #ffffff; color: #000000; border-radius: 999px; padding: 7px 10px; font-size: 0.78rem; cursor: pointer; }
        .os-chip:hover { background: rgba(242,101,34,0.10); border-color: #f26522; }
        .os-input-area { display: flex; padding: 12px; gap: 8px; border-top: 1px solid #d8d8d8; background: #f6f6f6; }
        .os-input-area input { flex: 1; padding: 10px 14px; border: 1px solid #d8d8d8; border-radius: 20px; font-size: 0.9rem; outline: none; }
        .os-input-area input:focus { border-color: #f26522; }
        .os-input-area button { background: linear-gradient(135deg, #ea510a, #f26522); color: white; border: none; border-radius: 50%; width: 38px; height: 38px; cursor: pointer; font-size: 1rem; }
